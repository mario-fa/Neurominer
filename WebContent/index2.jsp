...
<table id="Table_01" width="901" height="95%" border="0" cellpadding="0" cellspacing="0" align="center" background="">
        	...
        	<div id="menuAdmin" style="display:none">
                <ul id="MenuBar1" class="MenuBarHorizontal"> 
                    ...
                    <li style="width:110px;" ><a href="#" class="MenuBarItemSubmenu" >Administration</a>
	                    <ul>
	                        <li style="width:113px;"><a href="#"  onclick="CarregarContainer('joinUser.jsp')" >Join the User</a></li>
              	...
              	<script type="text/javascript">
                	var MenuBar1 = new Spry.Widget.MenuBar("MenuBar1", {imgDown:"menu/SpryMenuBarDownHover.gif", imgRight:"menu/SpryMenuBarRightHover.gif"});
                </script>               
       	  </div>
            <div id="menuUser" style="block">
                <ul id="MenuBar1" class="MenuBarHorizontal"> 
                    <li style="width:60px;" ><a href="#" onClick="CarregarContainer('home.jsp')">Home</a> </li> 
              	</ul>
              <script type="text/javascript">
	...
	<tr>
		<td colspan="6" style="width:712px;" bgcolor="#FFFFFF" valign="top" height="">
		<br/>
